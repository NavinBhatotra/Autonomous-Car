...
from computer.model import NeuralNetwork
from computer.rc_driver_helper import *
...
class SensorDataHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        while self.data:
            ...
            trim = self.data[0:6]
            sensor_data = round(float(trim), 1)
...
if __name__ == '__main__':
    h, p1, p2 = "192.168.31.120", 8000, 8002
